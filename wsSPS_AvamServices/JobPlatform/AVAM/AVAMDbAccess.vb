...
#Region "Public Methods"
		...
		Public Function CreateAVAMAdvertisement(ByVal customerID As String, ByVal userID As String, ByVal asStaging As Boolean, ByVal vacancyData As sp_WebServiceUtility.VacancyMasterData,
			...
			Try
				...
				Dim avamSyncObj = transferObj.AddAVAMAdvertisementToRAV(customerID, userID, asStaging, vacancyData, vacancyJobCHData, vacancyStmpData, vacancyStmpLanguageData, MDData, userObj, employerData, jobNumber, language)
