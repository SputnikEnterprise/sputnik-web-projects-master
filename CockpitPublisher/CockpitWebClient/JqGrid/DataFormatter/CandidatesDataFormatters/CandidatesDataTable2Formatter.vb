'------------------------------------
' File: CandidatesDataTable2Formatter.vb
' Date: 25.10.2011
'
...
''' <summary>
''' Data formatter for candidates data table 2.
''' </summary>
Public Class CandidatesDataTable2Formatter
    ...
    Protected Overrides Function FormatColumnData(ByVal rowData As DataRow) As Dictionary(Of String, String)
        ...
        columData.Add("TerminDate", DataFormattingHelper.FormatColumnAsDate(rowData, "TerminDate"))
        ...
        If Not rowData.IsNull("zTermin") Then
            strArt = rowData("zTermin")
