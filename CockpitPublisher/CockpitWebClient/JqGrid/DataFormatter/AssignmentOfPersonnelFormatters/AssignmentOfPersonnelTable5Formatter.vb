'------------------------------------
' File: AssignmentOfPersonnelTable5Formatter.vb
' Date: 25.10.2011
'
...
''' <summary>
''' Data formatter for assignment of personnel table 5.
''' </summary>
Public Class AssignmentOfPersonnelTable5Formatter
    ...
    Protected Overrides Function FormatColumnData(ByVal rowData As DataRow) As Dictionary(Of String, String)
        ...
        columData.Add("ESBranche", DataFormattingHelper.FormatAsString(rowData, "ESBranche"))
