'------------------------------------
' File: AssignmentOfPersonnelTable4Formatter.vb
' Date: 25.10.2011
'
...
''' <summary>
''' Data formatter for assignment of personnel table 4.
''' </summary>
Public Class AssignmentOfPersonnelTable4Formatter
    ...
    Protected Overrides Function FormatColumnData(ByVal rowData As DataRow) As Dictionary(Of String, String)
        ...
        columData.Add("ES_Ab", DataFormattingHelper.FormatAsString(rowData, "ES_Ab"))
