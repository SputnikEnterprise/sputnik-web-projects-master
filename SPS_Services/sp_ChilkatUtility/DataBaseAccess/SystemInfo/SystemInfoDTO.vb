...
Namespace DataTransferObject.SystemInfo.DataObjects
  ...
  End Class
	...
	Public Class CandidateDataDTO
		...
		Public Property Salution As String
		...
		Public Property AdvisortTelefon As String
		Public Property AdvisorTelefax As String
		Public Property AdvisoreMail As String
		Public Property Properties As String
		'Public Property AdvisorData As SystemUserData
