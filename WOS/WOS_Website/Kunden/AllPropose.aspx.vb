...
''' <summary>
''' Shows 'AllPropose' documents.
''' </summary>
Partial Class AllPropose
...
#Region "Methods"
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		If Not LoadDocuments(grid, lblNumberOfDocsInfoAmount, pnlNumberOfDocs, DOC_ART, " AND IsNull(GetResult, 0) >= 1") Then
