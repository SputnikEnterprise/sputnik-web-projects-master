'---------------------------------------------------------
' Offene Verleihvertraege.aspx.vb
'
...
''' <summary>
''' Shows 'Offene Verleihvertraege' documents.
''' </summary>
Partial Class OffeneVerleihvertraege
...
#Region "Methods"
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		Dim previousPage As OffeneVerleihvertraege = Page.PreviousPage
	...
	Protected Sub GridView_RowCommand(ByVal source As Object, ByVal e As GridViewCommandEventArgs)
		...
		If e.CommandName = "AcceptContract" Then
			...
			If isPrintNecessary Then
				PdfDocId = dbId
			End If
			Server.Transfer("~/Kunden/OffeneVerleihvertraege.aspx")
