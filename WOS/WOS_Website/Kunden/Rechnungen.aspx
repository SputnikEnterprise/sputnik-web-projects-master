<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" Inherits="WOS_Website.Rechnungen" Codebehind="Rechnungen.aspx.vb" %>

<asp:Content ID="PageHeader" ContentPlaceHolderID="head" runat="Server">
    <title><iwc:Literal TextKey="TEXT_PAGETITLE_BILLS" runat="server" /></title>
</asp:Content>
<asp:Content ID="PageContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        ...
        <asp:GridView ID="grid" runat="server" GridLines="None" DataKeyNames="ID" AutoGenerateColumns="false"
            CssClass="grid" AllowPaging="True" PageSize="18">
