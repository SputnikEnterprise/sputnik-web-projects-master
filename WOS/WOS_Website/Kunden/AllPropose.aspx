<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" Inherits="WOS_Website.AllPropose" Codebehind="AllPropose.aspx.vb" %>

<asp:Content ID="PageHeader" ContentPlaceHolderID="head" runat="Server">
  <title><iwc:Literal TextKey="TEXT_PAGETITLE_RENTAL_PROPOSE" runat="server" /></title>
</asp:Content>
