<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="WOS_Website.Arbeitsbescheinigung" MasterPageFile="~/MasterPage.master" Codebehind="Arbeitsbescheinigung.aspx.vb" %>

<asp:Content ID="PageHeader" ContentPlaceHolderID="head" runat="Server">
    <title><iwc:Literal TextKey="TEXT_PAGETITLE_CERTIFICATE_OF_EMPLOYMENT" runat="server" /></title>
</asp:Content>
