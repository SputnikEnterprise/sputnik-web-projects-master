<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="WOS_Website.Zwischenverdienstformulare" MasterPageFile="~/MasterPage.master" Codebehind="Zwischenverdienstformulare.aspx.vb" %>

<asp:Content ID="PageHeader" ContentPlaceHolderID="head" runat="Server">
    <title><iwc:Literal TextKey="TEXT_PAGETITLE_BETWEEN_EARNINGS_FORM" runat="server" /></title>
</asp:Content>
