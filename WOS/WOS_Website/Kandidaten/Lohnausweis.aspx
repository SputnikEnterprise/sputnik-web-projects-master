<%@ Page Language="VB" AutoEventWireup="false" Inherits="WOS_Website.Lohnausweis"
    MasterPageFile="~/MasterPage.master" Codebehind="Lohnausweis.aspx.vb" %>

<asp:Content ID="PageHeader" ContentPlaceHolderID="head" runat="Server">
    <title><iwc:Literal TextKey="TEXT_PAGETITLE_WAGE_STATEMENT" runat="server" /></title>
</asp:Content>
