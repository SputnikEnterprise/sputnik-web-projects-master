<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="WOS_Website.MARapporte" MasterPageFile="~/MasterPage.master" Codebehind="MARapporte.aspx.vb" %>

<asp:Content ID="PageHeader" ContentPlaceHolderID="head" runat="Server">
    <title><iwc:Literal TextKey="TEXT_PAGETITLE_SIGNED_REPORTS" runat="server" /></title>
</asp:Content>
