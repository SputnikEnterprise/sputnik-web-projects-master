'---------------------------------------------------------
' Arbeitsbescheinigungen.aspx.vb
'
...
''' <summary>
''' Shows 'Arbeitsbescheinigung' documents.
''' </summary>
Partial Class Arbeitsbescheinigung
    Inherits CandidatesBasePage

#Region "Properties"
    Private Const DOC_ART As String = "Arbeitgeberbescheinigung"
#End Region
