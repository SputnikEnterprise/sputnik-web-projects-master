<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="WOS_Website.Einsatzvertraege" MasterPageFile="~/MasterPage.master" Codebehind="Einsatzvertraege.aspx.vb" %>

<asp:Content ID="PageHeader" ContentPlaceHolderID="head" runat="Server">
    <title><iwc:Literal TextKey="TEXT_PAGETITLE_OPERATING_CONTRACTS" runat="server" /></title>
</asp:Content>
