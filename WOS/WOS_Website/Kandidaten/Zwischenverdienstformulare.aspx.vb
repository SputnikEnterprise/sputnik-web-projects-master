'---------------------------------------------------------
' Zwischenverdienstformulare.aspx.vb
'
...
''' <summary>
''' Shows 'Zwischenverdienstformulare' documents
''' </summary>
Partial Class Zwischenverdienstformulare
    Inherits CandidatesBasePage

#Region "Properties"
    Private Const DOC_ART As String = "Zwischenverdienstformular"
#End Region
